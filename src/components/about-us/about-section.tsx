      ...
      <div className="flex flex-col space-y-16 pt-10 sm:pt-0">
        ...
        <div className="mx-auto max-w-7xl space-y-4 px-6 text-center lg:px-20">
          ...
          <p className="text-lg leading-relaxed text-gray-700">
            En <strong>Jake Tienda Electrónica</strong>, somos apasionados por
            el sonido profesional y la tecnología. Desde nuestra sede en{" "}
            <strong>Popayán, Colombia</strong>, ayudamos a DJs, músicos,
            negocios e instituciones a encontrar el equipo perfecto:{" "}
            <strong>
              parlantes, controladoras DJ, subwoofers, consolas y más
            </strong>
            . Nuestro enfoque es brindar asesoría personalizada, productos de
            alta calidad y <strong>opciones de financiación</strong> para que
            nadie se quede sin sonar como quiere.
          </p>
        </div>
          ...
          <section className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center text-center lg:text-left">
              ...
              <p className="mt-4 leading-relaxed text-gray-600">
                La historia de Jake Tienda Electrónica comenzó con una pasión
                por el sonido. siempre soñe con crear una tienda donde los
                músicos, DJs y amantes de la tecnología pudieran encontrar no
                solo productos, sino también confianza, asesoría y comunidad. Lo
                que empezó como un pequeño negocio en Popayán, hoy es un
                referente en el sur de Colombia. Esta tienda fue creada pensando
                en ti, en tu ritmo y en tu necesidad de sonar mejor.
              </p>
            </div>
          </section>
          ...
          <section className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="rounded-2xl bg-white p-8 shadow-md">
              ...
              <p className="text-gray-600">
                ...
                accesible para todos en Colombia, con equipos de alto
                rendimiento, asesoría honesta y múltiples métodos de pago,
                incluyendo <strong>crédito en línea</strong>.
              </p>
            </div>
            <div className="rounded-2xl bg-white p-8 shadow-md">

...
function jsonLdLocalBusiness() {
  return {
    ...
    url: typeof window !== "undefined" ? window.location.origin : "https://jaketiendaelectronica.com",
...
export default function AboutSection() {
  ...
  const handleCopy = async (text: string, type: "address") => {
    try {
      ...
      // Silencioso: algunos navegadores requieren interacción
    }
  };
    ...
    <div className="flex flex-col space-y-16 pt-10 sm:pt-20">
      ...
      <div className="mx-auto max-w-7xl space-y-4 px-6 text-center lg:px-20">
        ...
        <p className="text-lg leading-relaxed text-gray-700">
          En <strong>{STORE.name}</strong> somos apasionados por el sonido profesional y la tecnología. Desde{" "}
          <strong>Popayán, Colombia</strong>, ayudamos a DJs, músicos, negocios e instituciones a encontrar el equipo
          perfecto: <strong>parlantes, controladoras DJ, subwoofers, consolas y más</strong>. Brindamos asesoría
          personalizada, productos de alta calidad y <strong>financiación</strong> para que nadie se quede sin sonar
          como quiere.
        </p>
      </div>
      ...
      <div className="mx-auto flex max-w-7xl flex-col space-y-16 px-6 py-10 lg:px-20">
         ...
         <div className="relative w-full">
          ...
          <div className="flex flex-col justify-center text-center lg:text-left">
            ...
            <p className="mt-4 leading-relaxed text-gray-600">
              La historia de {STORE.name} comenzó con una pasión por el sonido. Soñé con una tienda donde músicos, DJs y
              amantes de la tecnología encontraran no solo productos, sino confianza, asesoría y comunidad. Lo que empezó
              en Popayán hoy es referente en el sur de Colombia. Esta tienda fue creada pensando en ti: en tu ritmo y en
        ...
        <section className="flex flex-col space-y-6">
          <h2 className="text-center text-3xl font-bold text-gray-900">Nuestra Ubicación</h2>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div className="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-black/5">
              <p className="text-sm uppercase tracking-wide text-gray-500">Dirección</p>
              <h3 className="mt-1 text-xl font-semibold text-gray-900">{STORE.address}</h3>
              ...
              <div className="mt-4 flex items-center justify-between rounded-xl bg-gray-50 p-3">
                <span className="text-sm text-gray-700">Calle 6 #10-09, Centro, Popayán</span>
                <button
              ...
              <p className="mt-4 text-xs text-gray-500">
                Consejo: si ves que el pin no cae exactamente en la puerta, usa “Street View” en Google Maps y deja tu
                marcador guardado para futuras visitas.
              </p>
            </div>
          </div>
        ...
        <section className="grid grid-cols-1 gap-8 md:grid-cols-2">
          <div className="rounded-2xl bg-white p-8 shadow-md ring-1 ring-black/5">
            ...
            <p className="text-gray-700">
              Ofrecer <strong>tecnología de sonido profesional</strong> accesible para toda Colombia, con equipos de alto
              rendimiento, asesoría honesta y múltiples métodos de pago, incluido <strong>crédito en línea</strong>.
            </p>
          </div>
          <div className="rounded-2xl bg-white p-8 shadow-md ring-1 ring-black/5">
            <h3 className="mb-3 text-2xl font-bold text-gray-900">Visión</h3>
            <p className="text-gray-700">
              Ser la <strong>tienda líder en audio profesional</strong>, reconocida por la calidad de nuestros productos,
              servicio cercano y una experiencia de compra impecable.
            </p>
          </div>
        </section>
      </div>

  ...
  return (
    <div className="flex w-full flex-col space-y-6">
      ...
      <div className="flex flex-col gap-3 rounded border border-gray-300 p-4">
        ...
        />
        <p className="text-sm text-gray-600">Pago en línea (Tarjeta • PSE • Nequi)</p>
      ...
      <div className="flex flex-col gap-3 rounded border border-gray-300 p-4">
        <Price
          ...
          currencyCode={currency}
        />
        <p className="text-sm text-gray-600">Financia tu compra con Addi (+5%)</p>
        <button
      ...
      <div className="flex items-start gap-3 rounded border border-amber-200 bg-amber-50 p-3 text-sm text-amber-900">
        ...
        <p>
          ...
          <span className="font-semibold">Gora</span> se gestionan directamente en
          nuestra  tienda fisica, la direccion es: <span className="font-semibold">Calle 6 #10-09, Centro de Popayán</span>.
        </p>
      </div>
      ...
      {showAddiModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <div className="relative z-10 w-full max-w-md rounded-2xl bg-white p-6 shadow-xl animate-fadeIn">
            <button
              onClick={() => setShowAddiModal(false)}
            ...
            <div className="text-center mb-6">
             ...
             <ol className="list-decimal list-inside space-y-3 text-gray-700 mb-6">
              ...
              <li>La compra debe tener un valor minimo de $50.000 pesos colombianos.</li>
            </ol>

            <button
              onClick={() => (window.location.href = addiWhatsAppHref)}
              className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-6 py-3 rounded-xl w-full transition-all"
            >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 w-full max-w-md rounded-2xl bg-white p-6 shadow-xl animate-fadeIn">
            ...
            <div className="text-center mb-5">
              <Landmark size={36} className="mx-auto text-blue-600 mb-2" />
              <h2 className="text-2xl font-bold text-gray-800">
            ...
            <ol className="list-decimal list-inside space-y-3 text-gray-700 mb-6">
              ...
              <li>
                Contar con una cuenta activa en el Banco de Bogotá o estar dispuesto a
                abrir una.
              </li>
            </ol>
            ...
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-xl w-full transition-all"
            >
              Entendí la información y deseo continuar
            </button>
            ...
            {!confirmDirect ? (
              <>
                ...
                <p className="text-gray-700 mb-3">
                  Al pagar directamente por <strong>transferencia bancaria</strong>{" "}
                  obtienes un descuento del <strong>4%</strong>.
                </p>
              ...
              <>
                ...
                <p className="text-gray-700 mb-4">
                  Serás redirigido a nuestro WhatsApp para coordinar el pago con un
                  asesor.
                </p>
                <Link
